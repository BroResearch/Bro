...
<@layout.mainLayout title="Edit User">
    ...
    <div class="overflow-hidden rounded bg-background shadow sm:rounded-lg">
        <form action="/user/${user.userId}" method="post" enctype="multipart/form-data">
            <div class="flex">
                ...
                <dl>
                    <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        ...
                        <dd class="mt-1 text-sm text-background sm:col-span-2 sm:mt-0">
                            <input value="${user.displayName}" type="text" name="display-name" id="display-name" autocomplete="given-name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                        </dd>
                    </div>
                    <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        <dt class="text-sm font-medium text-purple">Email address</dt>
                        <dd class="mt-1 text-sm text-background sm:col-span-2 sm:mt-0">
                            <input value="${user.email}" type="text" name="email-address" id="email-address" autocomplete="given-name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                        </dd>
                    </div>
                    <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                      ...
                      <span class="inline-block h-12 w-12 overflow-hidden rounded-full bg-currentLine">
                        <img class="h-full w-full rounded-full"
                            ...
                            <input value="uploads/${user.profilePic}" id="file_input" type="file" class="ml-5 rounded-md border py-2 px-3 text-sm font-medium leading-4 text-gray-700 shadow-sm hover:bg-purple focus:outline-none focus:ring-2 focus:ring-pink focus:ring-offset-2"></input>
                        </dd>
                    </div>
                </dl>
            </div>
